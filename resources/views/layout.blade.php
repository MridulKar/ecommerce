...
<body>
        ...
        <div class="header-middle"><!--header-middle-->
            <div class="container">
                <div class="row">
                    ...
                    @if($customer != NULL)
                       <li><a href="/payment"><i class="fa fa-crosshairs"></i> Checkin</a></li>
                          @else
                            ...
                            @if($customer != NULL)
                              <li><a href="/customer_logout"><i class="fa fa-lock"></i> Logout</a></li>
                              @else 
                              <li><a href="/checkout"><i class="fa fa-lock"></i> Login</a></li>
 ...
 <div class="panel panel-default">
                            ...
                            <a  href="/catagory_product/{{$item->catagory_id}}">
                                             {{$item->catagory_name}}
                                        </a>
                                    </h4>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="/product_brand/{{$item->brand_id}}"> <span class="pull-right"></span>{{$item->brand_name}}</a></li>
