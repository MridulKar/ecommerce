						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							@endif
								...
								<td class="center">
								@if($item->publication_status==1)
									<a class="btn btn-danger"  href="/unactivebrand/{{$item->brand_id}}">
									<i class="halflings-icon white thumbs-up"></i>
								
									</a>
									@else
									<a class="btn btn-success" href="/activebrand/{{$item->brand_id}}">
									<i class="halflings-icon white thumbs-up"></i>
								
									</a>
									@endif

									<a class="btn btn-info" href="editbrand/{{$item->brand_id}}">
									<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="deletebrand/{{$item->brand_id}}">
